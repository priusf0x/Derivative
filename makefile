SOURCES = common/simple_parser.cpp tree/tree.cpp stack/stack.cpp common/tools.cpp tree/tree_dump.cpp deritative_main.cpp mathematics/deritative.cpp common/my_string.cpp mathematics/latex_dump.cpp
